...
data_path = 'results/mms_convergence_data.json'
...
# Velocity Plot
create_plot('mms_convergence_velocity.png', 'MMS Velocity Convergence (3D Boussinesq)', 
            'Velocity L2 Error', e_u, 'Velocity L2', show_h2=False, show_h3=True)

# Pressure Plot
create_plot('mms_convergence_pressure.png', 'MMS Pressure Convergence (Zero-Mean Pinned)', 
            'Pressure L2 Error', e_p, 'Pressure L2', show_h2=True, show_h3=False)

# Concentration Plot
create_plot('mms_convergence_concentration.png', 'MMS Concentration Convergence (3D Boussinesq)', 
            'Concentration L2 Error', e_c, 'Concentration L2', show_h2=False, show_h3=True)

print("Finished generating separate MMS convergence plots.")
